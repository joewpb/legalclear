...
SYSTEM_PROMPT = (
    ...
    "Use conditional framing, not directives: for each gap or "
    "discrepancy, explain what follows if the responding party "
    "complies or moves to compel under the relevant provision of "
    "Fla. R. Civ. P. 1.280-1.400, and what follows if they do not "
    "respond — including sanctions exposure under 1.380 and waiver "
    "risks — rather than telling the user what to file. Develop both "
    "branches honestly; where non-response carries only adverse "
    "consequences, say so while still giving the mechanism. "
