...
_FIRST_PARTY_SYSTEM_PROMPT = (
    ...
    "Do not cite specific statute chapter or section numbers — "
    "describe the framework and its deadlines in plain language, "
    "using the computed deadline dates and rule labels supplied in "
    "context below. "
